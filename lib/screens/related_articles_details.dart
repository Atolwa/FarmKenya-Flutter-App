...
import '../screens/related_articles_list.dart';

class RelatedArticleDetailView extends StatelessWidget {
  RelatedArticleDetailView({@required this.relatedArticles});
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: FutureBuilder<Article>(
          future: API.getArticle(relatedArticles.id),
